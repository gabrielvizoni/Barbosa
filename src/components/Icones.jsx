...
export const WhatsApp = (p) => (
  <svg {...base} {...p} fill="none">
    ...
    <path
      d="M8.5 8.7c.2-.5.4-.5.6-.5h.5c.2 0 .4 0 .5.4.2.5.6 1.6.6 1.7.1.1.1.3 0 .4-.1.2-.1.3-.3.4-.1.2-.3.3-.4.5-.1.1-.3.3-.1.6.2.3.8 1.3 1.7 2.1 1.2 1 2.1 1.4 2.4 1.5.3.1.5.1.6-.1.2-.2.7-.8.9-1 .2-.2.3-.2.6-.1.2.1 1.5.7 1.8.9.3.1.4.2.5.3.1.2.1.9-.2 1.5-.3.6-1.5 1.2-2 1.2-.5.1-1 .1-3.4-.9-2.9-1.2-4.6-4.1-4.8-4.3-.1-.2-1.1-1.5-1.1-2.8 0-1.4.7-2 .9-2.3Z"
      fill="currentColor"
      stroke="none"
    />
  </svg>
