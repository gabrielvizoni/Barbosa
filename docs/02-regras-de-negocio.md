...
| RN-14 | Na situação alvo, o expediente semanal é **individual por profissional** — não existe expediente global da barbearia como regra principal. As folgas recorrentes também são configuração do profissional (RN-49), e o bloqueio manual continua para exceções pontuais. Hoje o expediente é uma única grade global por dia da semana (`expediente`); a individualização é alvo e substitui essa tabela. | `planejado`       | `[PARCIAL]`      |
| RN-49 | Cada profissional tem **folgas recorrentes** próprias (ex.: não trabalha às segundas), distintas dos bloqueios pontuais de uma data específica.                                                                                                                                                                                                                                                        | `planejado`       | `[PLANEJADO]`    |
...
- **RN-14 / RN-49:** o expediente semanal passa a ser individual por
  profissional; não há expediente global como regra. Folgas recorrentes são
  configuração do profissional, separadas dos bloqueios pontuais.
